...
export default function Movie({ movie, onSave, onDelete }) {
    ...
    return (
        <Card className="shadow-lg p-3 mb-5 bg-white rounded mx-auto" bg="dark" style={{ width: '20rem' }}>
            <Card.Img variant="top" className="mx-auto" src="./movie_creation-black-18dp.svg" style={{ width: '4rem' }} />
            <Card.Body>
                <ReactStars
                        count={5}
                        ...
                        activeColor="#008000"
                    />
                <Card.Title>{movie.title} <small>{movie.year}</small></Card.Title>
                <Card.Text>
