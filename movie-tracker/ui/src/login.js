        ...
        if (!this.context.isLoggedIn) {
            ...
            return (
                <div className="w-100 h-100">
                    <SweetAlert
                        show={showAlert} title={title} text={text}
                            ...
                            <form onSubmit={this.handleFormSubmit} > {/* action="/login" method="post" */}
                                <div className="form-group">
                                    ...
                                    <input type="text" className="form-control" id="InputUsername" 
                                        aria-describedby="inputHelp" name="username" placeholder="Enter username" autoComplete="username"
                                ...
                                <div className="form-group">
                                    ...
                                    <input type="password" className="form-control" id="InputPassword" 
                                            name="password" placeholder="Enter a password" autoComplete="current-password"
