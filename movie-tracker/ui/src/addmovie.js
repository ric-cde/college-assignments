...
export default function AddMovie() {
    ...
    return (
      <>
        { context.isLoggedIn &&
          <Button variant="primary" size="md" onClick={handleShow} className="float-right mb-4">
            Add new recommendation
          </Button>
        }

        <SweetAlert
          show={showAlert} title={alertDetails.title} text={alertDetails.text}
        ...
        <Modal show={show} onHide={handleClose} centered>
          ...
          <Modal.Body><p className="text-secondary">This movie will be visible to all users.</p>
            <form onSubmit={handleAdd}>
              <Form.Group as={Row} controlId="movieTitle">
                <Form.Label column sm="2">Title</Form.Label>
                <Col sm="10">
                  <Form.Control name="title" type="text" placeholder="Movie name" required />
                </Col>
              </Form.Group>
              ...
              <Form.Group as={Row} controlId="movieYear">
                ...
                <Col sm="10">
                  <Form.Control name="year" type="number" placeholder="Release (YYYY)" pattern="[0-9]{4}" required />
                </Col>
              </Form.Group>
              ...
              <Form.Group as={Row} controlId="movieDirector">
                ...
                <Col sm="10">
                  <Form.Control name="director" type="text" placeholder="Film director(s)" required />
                </Col>
              </Form.Group>

              <Form.Group as={Row} controlId="movieRuntime">
                <Form.Label column sm="2">Runtime (minutes)</Form.Label>
                <Col sm="10">
                  <Form.Control name="runtime" type="number" placeholder="E.g. 120" required />
                </Col>
              </Form.Group>
              ...
              <Form.Group as={Row} controlId="movieGenres">
                ...
                <Col sm="10">
                  <Form.Control name="genres" type="text" placeholder="E.g. Comedy, Drama" required />
                </Col>
              </Form.Group>

              <Form.Group as={Row} controlId="movieIMDb">
                <Form.Label column sm="2">IMDb URL</Form.Label>
                <Col sm="10">
                  <Form.Control name="imdb" type="url" placeholder="Optional" />
                </Col>
              </Form.Group>
